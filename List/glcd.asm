...
; 0000 0038 // Graphic LCD initialization data
; 0000 0039 GLCDINIT_t glcd_init_data;
; 0000 003A 
; 0000 003B // Graphic LCD initialization
; 0000 003C // The KS0108 connections are specified in the
; 0000 003D // Project|Configure|C Compiler|Libraries|Graphic LCD menu:
...
; 0000 0046 // E - PORTD Bit 2
; 0000 0047 // RD /WR - PORTD Bit 1
; 0000 0048 // RS - PORTD Bit 0
; 0000 0049 // /RST - PORTD Bit 5
; 0000 004A // CS1 - PORTD Bit 3
; 0000 004B // CS2 - PORTD Bit 4
; 0000 004C 
...
; 0000 0056 glcd_init(&glcd_init_data);
	...
	RCALL _glcd_init
; 0000 0057 
; 0000 0058 glcd_outtextxyf(20,20,"WWW.NAMINIC.COM");
	LDI  R30,LOW(20)
	ST   -Y,R30
	ST   -Y,R30
	__POINTW2FN _0x0,0
